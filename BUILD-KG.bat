...
REM  The figureparts pass samples the corpus (default 4000 docs / 50000 parts cap, v1.4.0) --
REM  override with --sample-docs N and/or --parts-cap N, e.g.:
REM    BUILD-KG.bat --sample-docs 8000 --parts-cap 100000
REM ============================================================================================
cd /d "%~dp0engine"
